    ...
    <div class="bg-[#E96479] min-h-screen flex flex-col items-center justify-center w-full">
      ...
      <div class="form mt-10 h-[100%] w-[60%] bg-[#D9D9D9] rounded-xl">
          ...
          <div class="input-form flex flex-col justify-start mt-8 gap-y-5 px-2 sm:px-44 relative">
                <input placeholder="Write Comment Here ..." type="text" name="comment" id="comment" class="pl-3 rounded-md w-full h-8 border-b-4 border-blue-500 bg-white" ref="err" v-model="err">
                <div class="flex flex-row items-center justify-between">
                  <button class="btn btn-active btn-error w-20 mt-2 mb-10">Button</button>
