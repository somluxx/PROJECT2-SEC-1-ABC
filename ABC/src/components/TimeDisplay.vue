...
<div class="bg w-full h-4/5 p-2">
    ...
    <div class="flex-col justify-center">
        ...
        <div class="flex justify-end">
          <button class="btn btn-xs bg-[#4D455D] hover:bg-[#483b63] text-center rounded-xl w-40 h-20 text-white text-3xl font-bold mr-5 sm:btn-sm md:btn-md lg:btn-lg" @click="$emit('openTask',true)">Task
          </button>
